...
/** Packs bundle — intégré dans la boutique produits ou page dédiée. */
const ProductPacksPanel = ({ embedded = false }) => {
    ...
    <div id="packs-produits">
      ...
      {embedded && (
        <p style={{ margin: '0 0 16px', fontSize: 14, color: '#64748b' }}>
          Bundles chiot, chaton, senior ou sportif — <strong>-8 %</strong> sur le pack complet.
        </p>
      )}
      ...
      {msg && (
        <p style={{ color: msg.includes('ajouté') ? '#059669' : '#b91c1c', fontWeight: 600, marginBottom: 12 }}>
          {msg}
        </p>
      )}
      ...
      {!embedded && (
        <p style={{ marginTop: 24 }}>
          <Link to="/client-products">← Boutique produits</Link>
          {' · '}
...
export default ProductPacksPanel;
