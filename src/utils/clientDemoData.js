...
export const DEMO_COMPLAINTS = [
  {
    _id: 'demo-comp-001',
    id: 'demo-comp-001',
    subject: 'Produit abîmé à réception',
    category: 'product',
    message: 'Un article du pack était légèrement abîmé à réception — remplacement demandé.',
    status: 'resolved',
    response: 'Bonjour, un avoir de 15 DT a été crédité sur votre wallet. Merci pour votre patience.',
  ...
  },
  {
    ...
    category: 'delivery',
    message: 'Commande #9085 prévue hier — toujours en statut « expédiée » sans nouvelle du livreur.',
    status: 'pending',
    createdAt: daysAgo(1),
  },
  {
    _id: 'demo-comp-004',
    id: 'demo-comp-004',
    subject: 'Croquettes différentes de la commande',
    category: 'product',
    message: 'J\'ai reçu croquettes chat au lieu de chien (12 kg). Photo jointe dans l\'app.',
    status: 'ai_proposed',
    createdAt: daysAgo(2),
  },
  {
    ...
    category: 'payment',
    message: 'Retour produit validé le 28/06 — remboursement annoncé sous 5 jours, toujours rien.',
    status: 'pending',
    createdAt: daysAgo(5),
  },
  {
    _id: 'demo-comp-006',
    id: 'demo-comp-006',
    subject: 'Service toilettage décevant',
    category: 'service',
    message: 'Rendez-vous toilettage : animal stressé, coupe inégale — demande geste commercial.',
    status: 'rejected',
    response: 'Après vérification avec le salon partenaire, la prestation correspond au forfait réservé.',
    createdAt: daysAgo(12),
  },
  {
    _id: 'demo-comp-007',
    id: 'demo-comp-007',
    subject: 'Colis incomplet',
    category: 'product',
    message: 'Il manque le jouet offert dans la promo « Pack été chien ».',
    status: 'resolved',
    response: 'Le jouet manquant sera expédié sous 48 h — suivi SMS envoyé.',
    createdAt: daysAgo(8),
  },
];
...
export const DEMO_IOT_PACK = {
  ...
  devices: [
    ...
    },
    {
      ...
      status: 'online',
      petName: 'Max',
      route: '/client-products?tab=advanced',
    ...
    },
    {
      ...
      petName: 'Max',
      petType: 'dog',
      route: '/client-products?tab=wearable',
  ...
  alerts: [
    ...
    { id: 'a5', source: 'feeder-cam', severity: 'medium', title: 'Qualité croquettes — limite', message: 'Score qualité 72/100 — température et humidité du bac à surveiller.', deviceId: 'demo-esp32cam-1', link: '/client-products' },
    ...
    { id: 'a7', source: 'wearable-collar', severity: 'medium', title: 'Collier Luna — activité', message: 'Rythme cardiaque 138 bpm au repos — surveiller si persistant.', deviceId: 'demo-wearable-luna', link: '/client-products' },
  ],
  automations: [
